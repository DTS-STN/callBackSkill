...
Param(
    ...
    [string] $luisEndpoint ="https://virtual-assistant-luis-bdm-dev.cognitiveservices.azure.com/",
    [switch] $useGov,
	[string] $languages = "en-us",
    # [string] $qnaEndpoint = "https://westus.api.cognitive.microsoft.com/qnamaker/v4.0",
     [string] $qnaEndpoint = "https://virtual-assistant-luis-bdm-dev.cognitiveservices.azure.com/",
